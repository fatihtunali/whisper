    ...
    <main className="min-h-screen bg-gray-950">
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-6xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-indigo-600/10 border border-indigo-500/20 rounded-full px-4 py-2 mb-8">
            ...
            <span className="text-indigo-400 text-sm font-medium">End-to-End Encrypted</span>
          </div>

          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
            Private. Secure.<br />
            <span className="text-indigo-500">Anonymous.</span>
          </h1>

          <p className="text-xl text-gray-400 max-w-2xl mx-auto mb-12">
            Whisper is an end-to-end encrypted messaging app that requires no phone number,
          ...
          <div className="relative max-w-sm mx-auto">
            <div className="bg-gray-900 rounded-3xl p-3 shadow-2xl shadow-indigo-500/10 border border-gray-800">
              <div className="bg-gray-950 rounded-2xl overflow-hidden">
                ...
                <div className="p-4 space-y-3 min-h-[300px]">
                  ...
                  <div className="flex justify-start">
                    <div className="bg-gray-800 rounded-2xl rounded-bl-md px-4 py-2 max-w-[80%]">
                      <p className="text-gray-200 text-sm">Not even Whisper servers!</p>
      ...
      <section id="features" className="py-20 px-6 bg-gray-900/50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Why Choose Whisper?</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Feature 1 */}
            <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6 hover:border-indigo-500/50 transition-colors">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-indigo-600 rounded-2xl flex items-center justify-center mx-auto mb-4 text-2xl font-bold text-white">1</div>
              <h3 className="text-lg font-semibold text-white mb-2">Download</h3>
              <p className="text-gray-400 text-sm">Get Whisper from the App Store or Google Play.</p>
            </div>

            {/* Step 2 */}
            <div className="text-center">
              <div className="w-16 h-16 bg-indigo-600 rounded-2xl flex items-center justify-center mx-auto mb-4 text-2xl font-bold text-white">2</div>
            ...
            {/* Step 3 */}
            <div className="text-center">
              <div className="w-16 h-16 bg-indigo-600 rounded-2xl flex items-center justify-center mx-auto mb-4 text-2xl font-bold text-white">3</div>
            ...
            {/* Step 4 */}
            <div className="text-center">
              <div className="w-16 h-16 bg-indigo-600 rounded-2xl flex items-center justify-center mx-auto mb-4 text-2xl font-bold text-white">4</div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-400 mb-8">
                Whisper uses the same encryption algorithms trusted by security experts worldwide.
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-white font-medium">Local Key Storage</h4>
                    <p className="text-gray-400 text-sm">Private keys are stored securely on your device and never transmitted.</p>
                  </div>
                </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-400 mb-8">Download Whisper today and experience truly private messaging.</p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="#" className="flex items-center gap-3 bg-indigo-600 text-white px-8 py-4 rounded-xl font-semibold hover:bg-indigo-700 transition-colors">
              <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/>
              </svg>
              Download for iOS
      ...
      <footer className="py-12 px-6 border-t border-gray-800">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <p className="text-gray-500 text-sm">&copy; 2026 Whisper. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </main>
