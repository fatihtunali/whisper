...
export const metadata: Metadata = {
  ...
  description: "Terms of Service for Whisper messaging application",
};
        ...
        <div className="space-y-10">
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed">
              By downloading, installing, or using Whisper (&quot;the App&quot;), you agree to be bound by these Terms of Service (&quot;Terms&quot;). If you do not agree to these Terms, please do not use the App. We reserve the right to modify these Terms at any time, and your continued use of the App constitutes acceptance of any modifications.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed">
              Whisper is a privacy-focused messaging application that provides end-to-end encrypted communication. The App allows users to send text messages securely without requiring personal information such as phone numbers or email addresses. All communications are encrypted on your device before transmission.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed mb-4">
              When you create an account with Whisper:
            </p>
            <ul className="space-y-2 text-gray-300 list-disc list-inside ml-4">
              <li>You will receive a unique Whisper ID (format: WSP-XXXX-XXXX-XXXX)</li>
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed">
              Your use of Whisper is also governed by our <Link href="/privacy" className="text-indigo-400 hover:text-indigo-300">Privacy Policy</Link>. Please review our Privacy Policy to understand our practices regarding your information. By using the App, you consent to the practices described in the Privacy Policy.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed">
              Whisper uses end-to-end encryption for all messages. This means that we cannot access the content of your communications. While we implement strong security measures, no system is completely secure. You acknowledge that you use the App at your own risk and are responsible for maintaining the security of your device and recovery phrase.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed">
              The App and its original content, features, and functionality are owned by Whisper and are protected by international copyright, trademark, patent, trade secret, and other intellectual property laws. You may not copy, modify, distribute, sell, or lease any part of the App without our prior written consent.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed">
              TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, WHISPER AND ITS AFFILIATES, OFFICERS, EMPLOYEES, AGENTS, AND LICENSORS SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR ANY LOSS OF PROFITS OR REVENUES, WHETHER INCURRED DIRECTLY OR INDIRECTLY, OR ANY LOSS OF DATA, USE, GOODWILL, OR OTHER INTANGIBLE LOSSES RESULTING FROM YOUR USE OF THE APP.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed">
              These Terms shall be governed by and construed in accordance with the laws of the Netherlands, without regard to its conflict of law provisions. Any disputes arising from these Terms or your use of the App shall be resolved in the courts of the Netherlands.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed">
              These Terms, together with our Privacy Policy, constitute the entire agreement between you and Whisper regarding your use of the App and supersede any prior agreements between you and Whisper relating to the App.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              <a href="mailto:legal@sarjmobile.com" className="text-indigo-400 hover:text-indigo-300 transition-colors">
                legal@sarjmobile.com
              </a>
            </p>
          </section>
        </div>
