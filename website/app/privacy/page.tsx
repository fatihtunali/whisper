...
export const metadata: Metadata = {
  ...
  description: "Privacy Policy for Whisper messaging application",
};
        ...
        <div className="space-y-10">
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed mb-4">
              Whisper (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;) is committed to protecting your privacy. This Privacy Policy explains how we handle your information when you use our messaging application.
            </p>
            <p className="text-gray-300 leading-relaxed">
              By using Whisper, you agree to the practices described in this policy. Our core principle is simple: we collect as little data as possible, and what we do handle is encrypted end-to-end.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed mb-4">
              Whisper is designed with privacy as its foundation. We explicitly do NOT collect:
            </p>
          ...
          <section>
            ...
            <ul className="space-y-3 text-gray-300">
              <li className="flex items-start gap-3">
                ...
                <div>
                  <strong>Your Whisper ID:</strong> A randomly generated identifier (WSP-XXXX-XXXX-XXXX) that serves as your unique address
                </div>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 text-indigo-500 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed mb-4">
              All messages sent through Whisper are end-to-end encrypted using industry-standard cryptographic algorithms:
            </p>
            <ul className="space-y-3 text-gray-300">
              <li className="flex items-start gap-3">
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed">
              Whisper is not intended for use by children under the age of 13. We do not knowingly collect any information from children under 13. If you believe a child under 13 is using our service, please contact us.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              <a href="mailto:privacy@sarjmobile.com" className="text-indigo-400 hover:text-indigo-300 transition-colors">
